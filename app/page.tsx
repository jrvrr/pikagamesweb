  ...
  return (
    <div className="min-h-screen bg-[#111311] text-zinc-900 font-sans">
      ...
      <section className="relative w-full min-h-[700px] md:min-h-[800px] flex flex-col md:flex-row items-center justify-between px-6 md:px-12 pb-12 pt-32 md:pt-40 overflow-hidden border-b-4 border-zinc-900 bg-[#111311]">
        ...
        <div className="relative z-10 md:w-1/2 flex flex-col items-start space-y-6">
        ...
        <div className="relative z-10 w-full mt-12 md:mt-0 md:w-1/2 flex justify-center md:justify-end gap-6 h-64 md:h-96">
      ...
      {/* Qué Buscas Section */}
      <section className="relative z-10 py-16 px-6 md:px-12 bg-white bg-dots border-b-4 border-t-4 border-zinc-900">
        <h2 className="text-3xl font-black mb-10 uppercase tracking-tight text-center text-zinc-900">¿Qué buscas?</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 max-w-5xl mx-auto">
          {[
            { title: 'Precio', folder: '/svg/folder1.svg' },
            { title: 'Popular', folder: '/svg/folder2.svg' },
            { title: 'Estreno', folder: '/svg/folder3.svg' },
            { title: 'Mario', folder: '/svg/folder4.svg' }
          ].map((item) => (
            <div 
               key={item.title} 
            ...
            >
              ...
              <div className="relative w-32 md:w-40 flex items-end justify-center">
                ...
                <div className="absolute bottom-2 w-16 md:w-20 transition-transform duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] group-hover:-translate-y-16 md:group-hover:-translate-y-20 z-10 flex flex-col items-center justify-start">
                   <img src="/cartucho.png" alt="Cartucho" className="w-full h-auto relative z-10" />
                </div>
      ...
      <div className="relative z-0 w-full skew-y-2 -mt-16 mb-[-3rem]">
        ...
        <section className="relative py-32 bg-diagonal-lines border-y-4 border-[#d0144c]">
          <div className="max-w-6xl mx-auto flex flex-col items-center -skew-y-2 px-6 md:px-12">
            <h2 className="text-3xl md:text-5xl font-black mb-16 text-center uppercase tracking-tighter text-white drop-shadow-[4px_4px_0px_rgba(0,0,0,0.4)] -rotate-1">
              El catálogo definitivo para tu Nintendo Switch
            </h2>
            <div className="flex flex-col md:flex-row justify-center items-center gap-12 w-full mt-8">
              <img 
                src="/1.png" 
      ...
      <section className="relative z-10 py-20 px-6 md:px-12 border-t-4 border-b-4 border-zinc-900 bg-white">
        <h2 className="text-3xl font-black mb-10 uppercase tracking-tight text-center text-zinc-900">Próximamente</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 max-w-6xl mx-auto">
          {[1, 2, 3, 4].map((item) => (
            <div key={item} className="bg-zinc-200 aspect-[3/4] rounded-xl border-4 border-zinc-900 shadow-[6px_6px_0px_0px_rgba(24,24,27,1)] hover:-translate-y-2 hover:shadow-[8px_8px_0px_0px_rgba(230,0,18,1)] transition-all flex items-center justify-center">
      ...
      {/* Catálogo Section */}
      <section className="py-20 px-6 md:px-12 border-b-4 border-zinc-900 bg-white">
        <h2 className="text-3xl font-black mb-10 uppercase tracking-tight text-center text-zinc-900">Catálogo</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 max-w-6xl mx-auto">
          {[1, 2, 3, 4].map((item) => (
            <div key={item} className="bg-zinc-200 aspect-[3/4] rounded-xl border-4 border-zinc-900 shadow-[6px_6px_0px_0px_rgba(24,24,27,1)] hover:-translate-y-2 hover:shadow-[8px_8px_0px_0px_rgba(230,0,18,1)] transition-all flex items-center justify-center">
      ...
      <section className="py-24 px-6 md:px-12 bg-white bg-dots border-b-4 border-zinc-900 overflow-hidden relative">
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="relative w-full mt-10">
            ...
            >
              {[
                { bgSvg: "/svg/comentario1.svg", text: "¡El mejor lugar para encontrar mis juegos favoritos! La entrega fue súper rápida.", name: "GamerPro99", rating: 5, color: "text-zinc-900" },
                { bgSvg: "/svg/comentario2.svg", text: "Me encanta la interfaz. Fue muy fácil encontrar lo que buscaba y el servicio es excelente.", name: "ZeldaFan", rating: 5, color: "text-white" },
                { bgSvg: "/svg/comentario3.svg", text: "Descubrí juegos indie increíbles. Definitivamente recomendaré esta tienda a mis amigos.", name: "IndieExplorer", rating: 4, color: "text-zinc-900" },
                { bgSvg: "/svg/comentario4.svg", text: "Compré el nuevo Mario aquí y llegó en perfectas condiciones. Precios competitivos.", name: "MarioBro", rating: 5, color: "text-zinc-900" },
                { bgSvg: "/svg/comentario5.svg", text: "Soy cliente frecuente y siempre tienen disponibilidad en los estrenos más esperados.", name: "SwitchMaster", rating: 5, color: "text-white" },
                { bgSvg: "/svg/comentario6.svg", text: "Tuve una duda con mi pedido y el soporte me respondió rapidísimo. Muy confiables.", name: "PikaTrainer", rating: 4, color: "text-zinc-900" }
              ].map((comment, i) => (
                <div key={i} className="w-[320px] h-[170px] md:w-[480px] md:h-[240px] shrink-0 snap-center relative hover:-translate-y-2 transition-transform duration-300 group flex items-center justify-center p-4 md:p-8">
                  ...
                  <div className="flex flex-col items-center text-center max-w-[85%] relative z-10 -mt-2">
                    <div className={`font-black text-xl md:text-2xl mb-1 ${comment.color}`}>{comment.name}</div>
                    <div className={`flex gap-1 mb-3 ${comment.color === 'text-white' ? 'text-white' : 'text-zinc-900'}`}>
                      {[...Array(5)].map((_, idx) => (
                    ...
                    <p className={`${comment.color} font-bold leading-tight text-sm md:text-base line-clamp-3`}>
                      "{comment.text}"
                    </p>
                  </div>
                </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:items-start w-full max-w-5xl pb-24 md:pb-0">
            ...
            <div className="flex flex-col items-center md:items-start text-center md:text-left z-20 w-full md:w-1/3">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4">
                <a href="#" className="w-12 h-12 p-2.5 rounded-xl transition-all duration-300 hover:scale-110 shadow-lg border-[3px] border-transparent hover:border-white bg-[#1877F2] flex items-center justify-center overflow-hidden">
                ...
                <a href="#" className="w-12 h-12 p-2.5 rounded-xl transition-all duration-300 hover:scale-110 shadow-lg border-[3px] border-transparent hover:border-white bg-black flex items-center justify-center overflow-hidden">
                ...
                <a href="#" className="w-12 h-12 p-2 rounded-xl transition-all duration-300 hover:scale-110 shadow-lg border-[3px] border-transparent hover:border-white bg-[#FF0000] flex items-center justify-center overflow-hidden">
                ...
                <a href="#" className="w-12 h-12 p-2.5 rounded-xl transition-all duration-300 hover:scale-110 shadow-lg border-[3px] border-transparent hover:border-white bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] flex items-center justify-center overflow-hidden text-white">
